...
const EditGroupModal = ({group, onClose, onUpdate, onDelete}) => {
  ...
  return (
    <div onClick={onClose} 
        className='bg-[#00000066] dark:bg-[#ffffff66] fixed inset-0 z-50 flex items-center justify-center'
    >
        {/* ** Edit section */}
       {    activeSection == "edit" && (
         <form 
            ...
            className='h-fit max-h-[90%] w-[95%] lg:w-[80%] min-w-[350px] border-1 rounded-2xl overflow-y-scroll border-light-txt2 dark:border-dark-txt2 bg-light-100 dark:bg-dark-100 text-light-txt dark:text-dark-txt'>
            {/* pictures */}
       ...
       { activeSection == "delete" && (
         <form 
            ...
            onClick={(e) => e.stopPropagation()} 
            className='h-fit max-h-[90%] w-[95%] lg:w-[60%] min-w-[350px] rounded-2xl border-1 overflow-y-scroll border-light-text2 dark:border-dark-txt2 bg-light-100 dark:bg-dark-100 text-light-txt dark:text-dark-txt'
         >
            {/* pictures */}
            <div className='w-full h-[190px] lg:h-[270px] relative'>
            {/* banner image */}
