...
import { Cake, CalendarCheck, Mail, Users } from 'lucide-react';
  ...
  return (
    <div className='size-full bg-light-100 text-light-txt dark:bg-dark-100 dark:text-dark-txt'>
        ...
        <div className='w-full h-[270px] relative'>
          {/* cover image */}
          {
            user.cover ? <img src={user.cover} alt='cover image' className='w-full h-[200px] object-cover' /> :
            <div className='w-full h-[200px] bg-light-300 dark:bg-dark-300'></div> 
          }
          {/* profile picture */}
          <img src={user.profilePic ? user.profilePic : "/assets/avatar.svg"} alt="profile pic" className='size-[150px] rounded-[50%] absolute left-8 bottom-0 border-4 border-light-100 dark:border-dark-100' />
        </div>
        {/* main infos */}
